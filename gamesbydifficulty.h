...
namespace ArcadeMenu {
	...
	/// <summary>
	/// Summary for gamesbydifficulty
	/// </summary>
	public ref class gamesbydifficulty : public System::Windows::Forms::Form
	{
	public:
		gamesbydifficulty(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(gamesbydifficulty::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &gamesbydifficulty::button1_Click_1);
			// 
			// button2
			// 
			...
			this->Name = L"gamesbydifficulty";
			this->Text = L"gamesbydifficulty";
