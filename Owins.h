...
namespace ArcadeMenu {
	...
	/// Summary for Owins
	/// </summary>
	public ref class Owins : public System::Windows::Forms::Form
	{
	public:
		Owins(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Owins::typeid));
			...
			this->label1->Text = L"Gosh... that Player 1, ";
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(158, 81);
			...
			this->label3->Size = System::Drawing::Size(231, 63);
			...
			this->label4->Location = System::Drawing::Point(105, 249);
			this->label4->Margin = System::Windows::Forms::Padding(6, 0, 6, 0);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(254, 63);
			...
			this->axWindowsMediaPlayer1->Location = System::Drawing::Point(336, 169);
			this->axWindowsMediaPlayer1->Name = L"axWindowsMediaPlayer1";
			this->axWindowsMediaPlayer1->OcxState = (cli::safe_cast<System::Windows::Forms::AxHost::State^>(resources->GetObject(L"axWindowsMediaPlayer1.OcxState")));
			this->axWindowsMediaPlayer1->Size = System::Drawing::Size(201, 58);
			...
			this->ClientSize = System::Drawing::Size(571, 377);
			...
			this->Name = L"Owins";
			this->Text = L"Owins";
			this->Load += gcnew System::EventHandler(this, &Owins::Owins_Load);
...
#pragma endregion
	private: System::Void Owins_Load(System::Object^  sender, System::EventArgs^  e) {
	}
	};
}
